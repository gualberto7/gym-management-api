...
Route::controller(App\Http\Controllers\MemberController::class)
    ->middleware('auth:sanctum')
    ->group(function () {
...
Route::controller(App\Http\Controllers\EntryController::class)
    ->middleware('auth:sanctum')
    ->group(function () {
...
Route::controller(App\Http\Controllers\GymController::class)
    ->middleware('auth:sanctum')
    ->group(function () {
